...
| 036 | [Operation Runtime 操作执行控制层与 Tool 迁移](036_operation_runtime_control_plane_and_tool_migration.md)               | 待办   | P1     | 基于已完成 TODO 029 的 Mutation attempt 纵向切片，建立 transport-independent Runtime，统一 Tool 的准入、授权、协调、预算、执行策略、结果与审计并分型推广。                    |
