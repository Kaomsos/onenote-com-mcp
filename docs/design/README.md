...
| [`mutation_readiness_and_call_design.md`](mutation_readiness_and_call_design.md) | OneNote mutation readiness 不可预先观测的状态模型、调用顺序、reconciliation 与 lifecycle 边界 | 平台限制为当前设计；生产加固目标由 TODO 029 跟踪 |
