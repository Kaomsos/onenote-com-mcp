...
- **Mutation Attempt Control:** Title/content edits, Rename, supported Reorder, Reparent, typed Delete, and Close use explicit policies for one bounded principal backend attempt plus content-free outcome and recovery fields. Every currently registered attempt executes at most once; operation-wide sagas and the future all-Tool registry belong to the planned Operation Runtime.
